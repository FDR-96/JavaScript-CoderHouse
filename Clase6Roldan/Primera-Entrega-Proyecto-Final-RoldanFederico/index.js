...
for (let producto of ordenadosPorMonto){
    ...
    console.log(producto.description.toUpperCase() + " Monto: " + producto.amount + "U$D Peso: " + producto.weight + "Kg Cantidad:", producto.quantity + " Unidades ");
    ...
    console.log( "Envio: " + shipping + "AR$");
    console.log( "Total: " + total + "AR$")
    

    document.write("<br>");
    document.write("<h2>Descripcion: " + producto.description.toUpperCase() + "</h2>");
    document.write("<h3>Monto: </span>" + producto.amount + "U$D</span></h3>");
    document.write("<h3>Peso: </span>" + producto.weight + "KG</span></h3>");
    document.write("<h3>Cantidad: </span>" + producto.quantity + "</span></h3>");
