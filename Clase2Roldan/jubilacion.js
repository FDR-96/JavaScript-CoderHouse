...
if(edad >= 60 && antiguedad < 25){
    console.log("Con una edad de " + edad + " y con una antigüedad de " + antiguedad + ", te corresponde una Jubilacion por edad."); 
}else if(edad < 60 && antiguedad >= 25){
    console.log("Con una edad de " + edad + " y con una antigüedad de " + antiguedad + ", te corresponde una Jubilacion por antigüedad anticipada."); 
}else if(edad >= 60 && antiguedad >= 25){
    console.log("Con una edad de " + edad + " y con una antigüedad de " + antiguedad + ", te corresponde una Jubilacion por antiguedad y edad adulta.") 
}else{
    console.log("Con una edad de " + edad + " y con una antigüedad de " + antiguedad + ", aun no  te corresponde una jubilacion.") 
}
